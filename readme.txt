...
Automatically sync any Vine @user or #hashtag!
...
<br>
<br>
First, download, install, and activate POWr Vine Feed. Then drop the widget anywhere in your theme. Or add to a page/post with the POWr icon in the WP editor.
<br>
= <a href='http://www.powr.io/tutorials/how-to-add-vine-feed-plugin-to-your-wordpress-site'>2 MINUTE INSTALL</a> =
<br>
= Free Features =
* Sync Vines from any @user or #hashtag.
* Adjust the priority to display your favorite content.
...
= How do I add Vine Feed to a page or blog post? = Add the shortcode **[powr-vine-feed label='Enter any label here']** to any page or post. Then visit your live site to edit.

= Can I add more than one Vine Feed? = Yes, absolutely!  To clone your Vine Feed, just add the exact same shortcode to pages or posts.  To create a new version of Vine Feed, add a different shortcode to each page or post, for example: **[powr-vine-feed label='first form']**, and **[powr-vine-feed label='second form']**.

= Will my users see the settings icon in the corner of the Vine Feed? = No! You only see the settings icon because you own the plugins. To temporarily hide it, click on your page and then type 'p + down arrow' (the letter p followed by the down arrow). You can show the icon again by typing 'p + up-arrow'.
